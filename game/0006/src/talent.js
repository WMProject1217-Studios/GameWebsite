    ...
    talentRandom(include) {
        ...
        return new Array(131)
            .fill(1).map((v, i)=>{
                ...
                if (window.wtfdsdh<4){
                    grade = 3;
                    length = talentList[grade].length;
                    random = Math.floor(Math.random()*length) % length;
                } else if (window.wtfdsdh<17){
                    grade = 2;
                    length = talentList[grade].length;
                    random = Math.floor(Math.random()*length) % length;
                } else if (window.wtfdsdh<49){
                    grade = 1;
                    length = talentList[grade].length;
                    random = Math.floor(Math.random()*length) % length;
                } else {
                ...
                window.wtfdsdh = window.wtfdsdh + 1;
