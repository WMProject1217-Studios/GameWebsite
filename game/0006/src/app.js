...
class App{
    ...
    initPages() {
        ...
        <div id="main">
            ...
            <button id="rank">排行榜，但并没有排行榜</button>
            <div id="title">
                人生重开模拟器 - 调试模式<br>
                <div style="font-size:1.5rem; font-weight:normal;">这垃圾人生一普朗克单位也不想呆了</div>
            </div>
        ...
        const talentPage = $(`
        <div id="main">
            <div class="head" style="font-size: 1.6rem">天赋抽卡 [Debug][talentlibs=131]</div>
            <button id="random" class="mainbtn" style="top: 50%;">131连抽！</button>
            <ul id="talents" class="selectlist"></ul>
            <button id="next" class="mainbtn" style="top:auto; bottom:0.1em">请选择几个都行</button>
        </div>
        `);
