            ...
            g = new function() {
                var s = function(n, a) {
                    ...
                    d = function(n, a) {
                        ...
                        this.play = function(n, a) {
                            o = 0, d = n, r = a, l = 360 * Math.random(), s = 1, Math.random() < .5 && (s = -1), f.clear(), f.beginFill(0), f.moveTo(0, 0), f.lineTo(1, 1), f.endFill(), TweenLite.fromTo(c, .6, {
                                rotation: 0
                            }, {
                                rotation: 360,
                                ease: Power1.easeOut,
